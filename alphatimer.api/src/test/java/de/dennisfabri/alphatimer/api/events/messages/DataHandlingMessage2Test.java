...
class DataHandlingMessage2Test {
    @Test
    void equalsTest() {
        DataHandlingMessage2 value1 = new DataHandlingMessage2((byte) 5,
                                                               (byte) 6,
                                                               456123,
                                                               TimeInfo.Normal,
                                                               TimeMarker.Empty);
        DataHandlingMessage2 value2 = new DataHandlingMessage2((byte) 5,
                                                               (byte) 6,
                                                               456123,
                                                               TimeInfo.Normal,
                                                               TimeMarker.Empty);
    ...
    void toStringTest() {
        assertEquals(
                "DataHandlingMessage2(lane=5, currentLap=6, timeInMillis=456123, timeInfo=Normal, timeMarker=Empty)",
                new DataHandlingMessage2((byte) 5,
                                         (byte) 6,
                                         456123,
                                         TimeInfo.Normal,
